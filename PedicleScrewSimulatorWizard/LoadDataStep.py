...
class LoadDataStep(PedicleScrewSimulatorStep):
    ...
    def __init__( self, stepid ):
      ...
      self.setDescription( "Load a volume into the scene. Click 'Load CBCT/CT from DICOM' to open the DICOM browser window. Click 'Load CBCT/CT from other file' to import other file types, including .nrrd" )
    ...
    def createUserInterface( self ):
      ...
      #load sample data
      self.__loadSampleCtDataButton = qt.QPushButton("Load sample CBCT/CT")
      ...
      dicomButton.setText('Load CBCT/CT from DICOM')
      self.__layout.addRow(dicomButton)
      
      #open load data dialog for adding nrrd files
      self.__loadScrewButton = qt.QPushButton("Load CBCT/CT from other file")
